...
from recipe.webshop.env.data import DEFAULT_SEED, build_goals, load_json, load_products_and_attrs
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Prepare WebShop parquet data for agent RL training.")
