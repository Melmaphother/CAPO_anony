#!/usr/bin/env python3
"""
Prepare ALFWorld TextWorld data for ARFT / verl training.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Prepare ALFWorld TextWorld parquet data for agent RL training.")
    parser.add_argument(
        "--input_dir",
        type=str,
